...
!
  use types
  use geometry, only: numCells,numInnerFaces,owner, neighbour,numNodes,numFaces,numTotal
  use utils, only: csr_to_k, find_index_position, find_main_diag_element_positions, i4vec2_sort_a, i4vec_print, i4vec_print2, &
      formatSTR,lc,rc1,rc2,nofloat,noint
  ...
  real(dp) :: totalfloat                         ! memory of total float.
